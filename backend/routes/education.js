...
const { getEducation, saveEducation, updateEducation, deleteEducation } = require("./../controllers/educationController");

// Routes for education
router.route("/:id").get(verifyHREmployee, getEducation);
router.route("/:id").post(verifyHREmployee, saveEducation);
router.route("/:id").put(verifyHREmployee, updateEducation);
router.route("/:id/:id2").delete(verifyHREmployee, deleteEducation);
